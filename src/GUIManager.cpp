...
void GUIManager::buildGui() {
    ...
    ImGui::Begin("Brush Settings", &popen, ImGuiWindowFlags_AlwaysAutoResize);
    ImGui::SliderFloat("Brush Radius", &brushRadius, 1, 100);
    ImGui::SliderFloat("Brush Strength", &brushStrength, 1, 100);
    ImGui::RadioButton("Toon Brush", &brushes, 1);
    ImGui::RadioButton("Black and White Brush", &brushes, 2);
    ImGui::RadioButton("Warm-Cool Brush", &brushes, 4);
    ImGui::RadioButton("Eraser", &brushes, 8);
    ImGui::End();
    if (mouseCapture) {
        ImGui::EndDisabled();
    }
